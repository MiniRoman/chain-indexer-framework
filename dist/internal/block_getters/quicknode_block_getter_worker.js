...
const quicknode_block_getter_js_1 = require("./quicknode_block_getter.js");
const worker_threads_1 = require("worker_threads");
const web3_eth_1 = __importDefault(require("web3-eth"));
if (!worker_threads_1.workerData || !worker_threads_1.parentPort) {
    process.exit(1);
}
const blockGetter = new quicknode_block_getter_js_1.QuickNodeBlockGetter(
//@ts-ignore
...
new web3_eth_1.default(
//@ts-ignore
new web3_eth_1.default.providers.WebsocketProvider(worker_threads_1.workerData.alternateEndpoint, {
    reconnect: {
        auto: true
    },
    clientConfig: {
    ...
    timeout: 45000
})), worker_threads_1.workerData.rpcTimeout);
...
//# sourceMappingURL=quicknode_block_getter_worker.js.map