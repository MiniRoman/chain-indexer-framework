 ...
 */
export declare class AsynchronousProducer extends AbstractProducer {
    private static readonly DELIVERED;
    /**
     ...
     */
    produceEvent(key: string, message: object, topic?: string, partition?: number, timestamp?: number, opaque?: object): Promise<KafkaError | boolean>;
}
