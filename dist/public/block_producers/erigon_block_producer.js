...
exports.ErigonBlockProducer = void 0;
 ...
 * @author - Vibhu Rajeev
 */
class ErigonBlockProducer extends block_producer_js_1.BlockProducer {
    /**
     * @constructor
     *
    ...
    constructor(config) {
        ...
        //@ts-ignore
        eth, endpoints, maxRetries, "erigon_block_getter", blockSubscriptionTimeout), new block_getter_js_1.BlockGetter(eth, maxRetries), database, database.model("ProducedBlocks", produced_blocks_model_js_1.ProducedBlocksModel, dbCollection), startBlock, maxReOrgDepth);
    }
}
exports.ErigonBlockProducer = ErigonBlockProducer;
//# sourceMappingURL=erigon_block_producer.js.map