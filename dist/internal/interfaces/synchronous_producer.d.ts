...
export interface ISynchronousProducer {
    produceEvent(topic: string, key: string, message: object, protobufMessageType: string, partition?: number, timestamp?: number): Promise<DeliveryReport | LibrdKafkaError | Error>;
